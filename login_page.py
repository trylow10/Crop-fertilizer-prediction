...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "Login", font=("times new roman", 40, "bold"), fg="red").place(x=100,y=120)
        label2 = Label(self.frame1, text= "Here", font=("times new roman", 40, "bold"), fg="RoyalBlue1").place(x=150,y=190)
        # label3 = Label(self.frame1, text= "Please fillup properly", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Welcome to predictlizer",parent=self.window)
