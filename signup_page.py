...
class SignUp:
    def __init__(self, root):
        ...
        # self.back = Button(frame,text="Go Back",command=self.go_back,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=120,y=470,width=150)
